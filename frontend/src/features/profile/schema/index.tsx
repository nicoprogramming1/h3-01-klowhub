...
export const createProfileProSchema = z
  .object({
    ...
    mentor: MentorDTOSchema.nullish(),
    isMentor: z.boolean(),
  })
  .transform((data) => {
    // Eliminar `mentor` si es nulo o indefinido
...
export const ProfileBasicSchema = z.object({
  id: z.string().optional(),
  longName: z.string().trim().min(1, "El nombre es obligatorio"),
  about: z.string().trim().min(1, "La descripción es obligatoria").optional(),
  imageProfile: z
    .union([
      z.instanceof(File),
