...
interface CarouselCardMemberProps {
  data: CardDataMember[];
  link: string;
}

const CarouselCardMember = ({ data, link }: CarouselCardMemberProps) => {
        ...
        <CarouselContent className="  h-auto">
          {data.map((item, index) => (
            ...
            >
              <div
                className={cn(
                  "flex items-center justify-center  transition-all duration-300 rounded-md   hover:shadow-lg max-w-[250px] max-h-[400px] w-full h-full",
...
export default CarouselCardMember;
